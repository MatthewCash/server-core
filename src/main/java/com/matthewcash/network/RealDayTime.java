...
public class RealDayTime {
    ...
    public static void startTimer() {
        final Plugin plugin = ServerCore.getPlugin();

        latitudeDeg = plugin.getConfig().getDouble("real_day_time.latitude");
        longitudeDeg = plugin.getConfig().getDouble("real_day_time.longitude");
    ...
    private static void updateTime() {
        ...
        final double solarHour = getSolarHour(
            ServerCore.getPlugin().getConfig()
                .getDouble("real_day_time.longitude")
        );
        ...
        World world = ServerCore.getPlugin().getServer()
            .getWorld(
                ServerCore.getPlugin().getConfig()
                    .getString("real_day_time.world")
            );
